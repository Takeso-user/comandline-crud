...
this project has a setup for GitHub Actions, which will build and test the project on every push to the repository. The status of the build can be seen in the "Actions" tab of the repository.